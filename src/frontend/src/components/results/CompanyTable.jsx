...
export default function CompanyTable({ data = mockData }) {
  ...
  const rows = data.map((row) => (
    ...
    >
      {/* Coluna do Checkbox com stopPropagation para não abrir os detalhes ao clicar nele */}
        ...
        <Table.Thead>
          <Table.Tr>
            {selectedRows.length > 0 ? (
              ...
              <Table.Th colSpan={10} style={{ backgroundColor: 'var(--mantine-color-blue-light)' }}>
              ...
              // Cabeçalho normal padrão com as colunas de empresas
              <>
